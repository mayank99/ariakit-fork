import { addGlobalEventListener, chain, contains, getActiveElement, getDocument, getWindow, isApple, isButton, isMac, isSafari, isVisible, noop, queueBeforeEvent, useBooleanEvent, useEvent, useForceUpdate, useId, useMergeRefs, usePortalRef, useSafeLayoutEffect, useWrapElement } from "./hooks-BNp9qiVx.js";
import { focusIfNeeded, getAllTabbableIn, getFirstTabbableIn, isFocusable } from "./focus-fCQxuv3j.js";
import { createElement, createHook, forwardRef } from "./system-BBb67kU9.js";
import { FocusableContext, isSafariFocusAncestor, useFocusable } from "./focusable-COT5YOJE.js";
import { sync, useStore, useStoreState } from "./store-Ddr50htY.js";
import { DialogDescriptionContext, DialogHeadingContext, DialogScopedContextProvider, createDisclosureStore, isHidden, useDialogProviderContext, useDisclosureContent, useDisclosureStore, useDisclosureStoreProps } from "./disclosure-store-Czymr2mJ.js";
import { HeadingLevel } from "./heading-level-lefJvr_C.js";
import { usePortal } from "./portal-DDotQodm.js";
...
//#endregion
export { Dialog, createDialogComponent, createDialogStore, useDialog, useDialogStore, useDialogStoreProps };